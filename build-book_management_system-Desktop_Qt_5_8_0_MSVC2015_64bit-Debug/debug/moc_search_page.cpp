...
#include "../../book_management_system/search_page.h"
...
QT_MOC_LITERAL(1, 12, 12), // "search_in_db"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 15) // "check_attribute"

    },
    "search_page\0search_in_db\0\0check_attribute"
};
...
void search_page::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->search_in_db(); break;
        case 1: _t->check_attribute(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject search_page::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_search_page.data,
      qt_meta_data_search_page,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *search_page::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_search_page.stringdata0))
        return static_cast<void*>(const_cast< search_page*>(this));
